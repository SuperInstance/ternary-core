# Getting Started — ternary-core-tmp
...
```bash
git clone https://github.com/SuperInstance/ternary-core-tmp.git
cd ternary-core-tmp
cargo build --release
cargo test
```
...
- Ternary {-1, 0, +1} semantics for core-tmp
...
// TernaryGrid is the primary type
let instance = {TernaryGrid::new();
// ... use it
```
